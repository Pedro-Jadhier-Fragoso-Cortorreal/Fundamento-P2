...
namespace GrMosler
{
    public partial class GestionRiesgos : Form
    {
        ...
        private void btnborrarF2_Click(object sender, EventArgs e)
        {
            {
                // Limpiar todas las filas del DataGridView de la Fase 2
                dataGridViewF2.Rows.Clear();
                MessageBox.Show("Datos de la Fase 2 borrados exitosamente.", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }

        private void btnBorrarF3F4_Click(object sender, EventArgs e)
        {
            dataGridViewF3_Calculos.Rows.Clear();
            dataGridViewF4_Clasificacion.Rows.Clear();
            MessageBox.Show("Datos de las Fases 3 y 4 borrados exitosamente.", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void btnBorrarTodo_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewF3_Calculos.Rows.Clear();
            dataGridViewF4_Clasificacion.Rows.Clear();
            MessageBox.Show("Todos los datos han sido borrados exitosamente.", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
